    ...
    <div className="border-t border-white/[0.03]">
      ...
      <div className="flex items-center gap-4 px-3 py-3">
        ...
        <div className="flex-1 grid grid-cols-2 gap-6 items-center">
          <span className={`text-[13px] tabular-nums font-medium ${row.authoring.length > 0 ? 'text-sky-400/60' : 'text-white/15'}`}>
            {row.authoring.length}
          </span>
          <span className={`text-[13px] tabular-nums font-medium ${row.reviewing.length > 0 ? 'text-amber-400/60' : 'text-white/15'}`}>
        ...
        <div className="flex-1 grid grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-1.5">
            {row.authoring.length === 0 ? (
              <div className="py-3 rounded-lg border border-dashed border-white/[0.04] flex items-center justify-center">
                <span className="text-white/15 text-[11px]">No open MRs</span>
              </div>
            ) : (
          ...
          <div className="flex flex-col gap-1.5">
            {row.reviewing.length === 0 ? (
              <div className="py-3 rounded-lg border border-dashed border-white/[0.04] flex items-center justify-center">
                <span className="text-white/15 text-[11px]">Nothing to review</span>
              </div>
            ) : (
